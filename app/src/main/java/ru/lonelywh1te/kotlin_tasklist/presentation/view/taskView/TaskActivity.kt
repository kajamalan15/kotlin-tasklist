...
class TaskActivity : AppCompatActivity() {
    ...
    private fun setTaskData() {
        ...
        if (task.completionDateInMillis != null) {
            ...
            binding.tvTaskCompletionDate.text = "Time"
        }
        ...
        if (task.taskGroupId != null) {
            ...
            binding.tvTaskGroupInfo.text = "List"
        }
    ...
    private fun setTaskCompletionDate() {
        ...
        if (task.completionDateInMillis != null) {
            datePickerDialog.setButton(DialogInterface.BUTTON_NEUTRAL, "Time & Date") { _, _ ->
                cancelTaskNotification()
    ...
    private fun setTaskGroup() {
        ...
        val negativeButtonTitle = if (task.taskGroupId == null) "Cancel" else "Delete"
